...
- **Shelf:** the book you read last is shown large at the top; every book stands below as a spine. Long-press a spine to edit the title and author or to remove the book.
...
src/
  ...
  library.js       shelf (hero + spines), import, edit/delete
